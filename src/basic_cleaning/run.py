...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name of the artifact prior to pre-processing",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Name of the artifact after pre-processing",
        required = True
    )
    ...
    parser.add_argument(
        ...
        type = str,
        help = "clean_sample",
        #I think we're naming it this to make sure that's the type in wandb
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = 'Description of the pre-processed artifact',
        required = True
    )
